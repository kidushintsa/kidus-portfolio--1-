      ...
      <AnimatePresence>
        {isOpen && (
          <>
            ...
            >
              {/* Menu Content */}
              <div className="flex-1 flex flex-col justify-center items-center px-6 bg-slate-900">
                {/* Navigation Links */}
                  ...
                  {navLinks.map((link, i) => (
                    ...
                    >
                      <button
                        ...
                        className="text-2xl font-medium text-white hover:text-blue-400 transition-colors duration-200 py-2 px-4 rounded-lg hover:bg-slate-800"
                      >
                        {link.label}
                      </button>
                    </motion.div>
              ...
              <motion.div
                ...
                animate="open"
                exit="closed"
                className="p-6 text-center border-t bg-slate-900 border-slate-700"
              >
                <p className="text-sm text-gray-400">© 2024 Kidus Hintsa</p>
              </motion.div>
            </motion.div>
          </>
        )}
